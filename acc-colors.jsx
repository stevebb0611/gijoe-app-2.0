// acc-colors.jsx — resolve the accessories CSV `color` strings into real
...
//
// Exports to window: colorFor(name) -> { css, solid, known, two }, AccSwatch.
...
(function () {
  ...
  // small swatch that takes a raw CSV colour string
  function AccSwatch({ color, size = 11, title }) {
