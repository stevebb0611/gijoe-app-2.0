...
const DM_FIG = (typeof window !== 'undefined' && window.FIG_MASKS) || {};
const DM_ZONES = (typeof window !== 'undefined' && window.FIG_ZONES) || {};
...
function DamageMap({ value, onChange, genderLocked }) {
  ...
  const { useState, useEffect } = React_;
  ...
  if (f && dm) {
    for (let r = 0; r < f.rows; r++) {
      for (let c = 0; c < f.cols; c++) {
        ...
        cells.push(React_.createElement('div', {
